...
<div class="sb-stack fill-slide story-screenshot-slide">
  ...
  <figure class="story-portrait-shot">
    ...
    />
    <figcaption>Newspeak House · February 2026</figcaption>
  </figure>
</div>
...
Now, some of you are thinking: that's where you drew the line? And that's fair. But here's the thing about Bubbles I hadn't thought hard enough about. She had credentials — a wallet, an inbox, and tokens for apps I'd never audited.
-->
...
<!--
Model capability isn't the hard part anymore — the models are good, the tools are getting reliable, and the model has even become a dial, where you choose how hard it thinks per request. The hard part now is building the systems around the models, the tools and the skills. Peter Steinberger, who built OpenClaw, put it this way: you shouldn't be prompting your agents anymore; you should design the loops that prompt them for you. He called it loop engineering.
...
<!--
Field stop one. At ClawClub hack nights I love going round the room — engineers, founders, people building their first agent. And almost everyone does the same thing with their first project. I did too. You write one giant instruction that tries to do everything all at once.
-->
...
<div class="sb-stack fill-slide civo-evidence">
  <div class="sb-stack tight">
    ...
    <h2>Five agents. One ambiguous source of truth.</h2>
  </div>

  <div class="origin-real-grid">
    <figure class="real-screenshot-frame origin-real-shot">
      <SBPublicImage
        src="/assets/screenshots/civo/cursor-origin-repository-ui.png"
        alt="Cursor Origin repository interface showing branches and pull requests"
      />
    </figure>
    <figure class="real-screenshot-frame origin-personal-shot">
      <SBPublicImage
        src="/assets/screenshots/civo/cursor-origin-personal.webp"
        alt="Fatima's Cursor Origin repository list stating that GitHub remains the source of truth"
      />
    </figure>
  </div>
</div>
...
<!--
Origin is Cursor's forge, and the agent side of it is good. I pointed five agents at one repository and they created branches, commits and pull requests faster than I could read them. Then I looked closer.
...
<div class="sb-stack fill-slide civo-evidence">
  ...
  <div class="buzz-real-composite">
    <figure class="real-screenshot-frame buzz-real-shot">
      <SBPublicImage
        src="/assets/screenshots/civo/buzz-agents-working.webp"
    ...
    <figure class="real-screenshot-frame buzz-roster-shot">
      <SBPublicImage
        src="/assets/screenshots/civo/buzz-agents-roster.webp"
...
<div class="sb-stack fill-slide civo-evidence">
  ...
  <div class="memory-verbs" aria-label="Search, inspect and delete memory">
    <span>search</span>
    <i></i>
    <span>inspect</span>
    <i></i>
